...
1)The dataset folder contains the data on which the pipeline was run. It also contains seperate csv(s) storing the data which was ignored

2)The dataset folder also contains analytics.xlsx file that contains all the analysis from the database